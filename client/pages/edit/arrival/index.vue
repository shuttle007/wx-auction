<template>
	<div class="edit-wrapper">
		...
		<div class="edit-item" @click='navToCompanies'>
			...
			<div class="item-section">{{comp}}</div>
			<div class='item-unit'>
				<div class='iconfont icon-more'></div>
			</div>
		</div>
		...
		<div class="edit-item" @click='navToEdit' :data-param="item.after_amount">
			<div class="item-tit">卸货吨数</div>
			<div class="item-section">{{item.after_amount}}吨</div>
			<div class='item-unit'>
				<div class='iconfont icon-more'></div>
			</div>
		</div>
...
<script>
	...
	export default {
		...
		mounted(){
			globalStore.state.comp = "";
		},
		computed: {
			comp() {
				var comp = this.item.company;
